 ...
 * </pre>
 */
public class FilipeliuJavaModuleClient {
     ...
     */
    public FilipeliuJavaModuleClient(URL url) {
     ...
     * validity.
     */
    public FilipeliuJavaModuleClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public FilipeliuJavaModuleClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public FilipeliuJavaModuleClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
     ...
     */
    public ReportResults runFilipeliuJavaModule(Map<String,UObject> params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<ReportResults>> retType = new TypeReference<List<ReportResults>>() {};
        List<ReportResults> res = caller.jsonrpcCall("filipeliu_java_module.run_filipeliu_java_module", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("filipeliu_java_module.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
