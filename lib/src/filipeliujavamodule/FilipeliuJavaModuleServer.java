...
public class FilipeliuJavaModuleServer extends JsonServerServlet {
    ...
    private static final String gitUrl = "git@github.com:Fxe/kbase_java_module.git";
    private static final String gitCommitHash = "25c455c65d733901b1ef441819b6f8b027e314de";
     ...
     * @return   parameter "output" of type {@link filipeliujavamodule.ReportResults ReportResults}
     */
    @JsonServerMethod(rpc = "filipeliu_java_module.run_html_report", async=true)
    public ReportResults runHtmlReport(Map<String,UObject> params, AuthToken authPart, RpcContext jsonRpcContext) throws Exception {
        ReportResults returnVal = null;
        //BEGIN run_html_report
        //END run_html_report
        return returnVal;
    }
     ...
     * @return   parameter "output" of type {@link filipeliujavamodule.ReportResults ReportResults}
     */
    @JsonServerMethod(rpc = "filipeliu_java_module.run_workspace_example", async=true)
    public ReportResults runWorkspaceExample(Map<String,UObject> params, AuthToken authPart, RpcContext jsonRpcContext) throws Exception {
        ReportResults returnVal = null;
        //BEGIN run_workspace_example
        //END run_workspace_example
        return returnVal;
    }
